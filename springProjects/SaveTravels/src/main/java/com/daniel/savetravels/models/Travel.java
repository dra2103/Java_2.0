package com.daniel.savetravels.models;
...
public class Travel {
	...
	@NotNull
	@Size(min = 3, max = 200, message = "Expense name required!!")
	private String expense;
	
	@NotNull
	@Size(min = 3, max = 200, message = "Vendor required!!")
	private String vendor;
	
	@NotNull
	@Min(value=(long) 0.01, message = "It can't be for free!?")
