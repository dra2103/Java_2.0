...
<body>
   ...
   <form:form action= "/expenses/new" method="post" modelAttribute="expenses" class="form-control container">
   		<p><form:errors class ="text-danger" path="expense"/></p>
   		<p><form:errors class ="text-danger" path="vendor"/></p>
   		<p><form:errors class ="text-danger" path="amount"/></p>
